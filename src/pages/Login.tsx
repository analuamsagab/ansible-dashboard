    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 relative overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Sign in to manage your servers</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500">
          ...
          <Link to="/register" className="text-emerald-400 hover:text-emerald-300 transition-colors">Register</Link>
        </p>
      </motion.div>
    </div>
  )
